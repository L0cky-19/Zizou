            ...
            <?php if ($isConnected): ?>
                ...
                <div id="user-menu" class="hidden">
                    <?php if ($userRole === 'admin'): ?>
                        <a href="./G/etudiants">Gestion des étudiants</a>
                        <a href="./G/pilotes">Gestion des pilotes</a>
                        <a href="./G/entreprises">Gestion des entreprises</a>
                        <a href="./G/offres">Gestion des offres</a>
